                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="py-lg-2 pr-lg-2">
                                <img src="{{ asset('assetsa/images/illustrator/1.png') }}" alt="" class="img-fluid mx-auto" style="max-height: 250px;">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block language-switch">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="eng">
                        <img src="{{ asset('assetsa/images/flags/us.jpg') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">English</span>
                    </a>
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp">
                        <img src="{{ asset('assetsa/images/flags/spain.jpg') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Spanish</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr">
                        <img src="{{ asset('assetsa/images/flags/germany.jpg') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">German</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it">
                        <img src="{{ asset('assetsa/images/flags/italy.jpg') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Italian</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru">
                        <img src="{{ asset('assetsa/images/flags/russia.jpg') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">Russian</span>
                    </a>
                </div>
            </div>
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0">
                    ...
                    <div data-simplebar style="max-height: 270px;">
                        <a class="notification-item text-reset" href="#!">
                            <div class="d-flex border-bottom align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assetsa/images/brands/slack.png') }}" alt="slack">
                                </div>
                        ...
                        <a class="notification-item text-reset" href="#!">
                            <div class="d-flex border-bottom align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assetsa/images/brands/behance.png') }}" alt="behance">
                                </div>
                                <div class="flex-grow-1 ms-4">
                        ...
                        <a class="notification-item text-reset" href="#!">
                            <div class="d-flex border-bottom align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assetsa/images/brands/dribbble.png') }}" alt="dribbble">
                                </div>
                                <div class="flex-grow-1 ms-4">
                        ...
                        <a class="notification-item text-reset" href="#!">
                            <div class="d-flex border-bottom align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assetsa/images/brands/dropbox.png') }}" alt="dropbox">
                                </div>
                                <div class="flex-grow-1 ms-4">
                        ...
                        <a class="notification-item text-reset" href="#!">
                            <div class="d-flex border-bottom align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assetsa/images/brands/mail_chimp.png') }}" alt="mail_chimp">
                                </div>
                                <div class="flex-grow-1 ms-4">
                        ...
                        <a class="notification-item text-reset" href="#!">
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{ asset('assetsa/images/brands/github.png') }}" alt="github">
                                </div>
                                <div class="flex-grow-1 ms-4">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item user text-start d-flex align-items-center" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ asset ('assetsa/images/users/kucing.jpg') }}"
                        alt="Header Avatar">
                    <span class="ms-2 d-none d-sm-block user-item-desc">
                        ...
                        $reference = $user->userReference->reference;
                        if ($reference && method_exists($reference, 'people')) {
                        $reference->load('people');
                        ...
                        @if ($people)
                        <span class="user-name">{{ $people->name }}</span>
                        @else
                        <span class="user-sub-title">student</span>
                        @endif
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    <div class="p-3 bg-primary border-bottom">
                        <h6 class="mb-0 text-white">{{ $people->name }}</h6>
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <button type="submit" class="dropdown-item">
                            <iconify-icon icon="solar:logout-2-linear" class="text-muted font-size-16 align-middle me-1"></iconify-icon>
