...
<!-- Mirrored from themewagon.github.io/strategy/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 May 2025 01:55:42 GMT -->
<!-- Added by HTTrack -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col" data-aos="fade-in" data-aos-delay="0">
                        <img src="{{ asset('assets/images/clients-05.svg') }}" alt="Image" class="img-fluid">
                    </div>
                    <div class="col" data-aos="fade-in" data-aos-delay="100">
                        <img src="{{ asset('assets/images/clients-02.svg') }}" alt="Image" class="img-fluid">
                    </div>
                    <div class="col" data-aos="fade-in" data-aos-delay="200">
                        <img src="{{ asset('assets/images/clients-03.svg') }}" alt="Image" class="img-fluid">
                    </div>
                    <div class="col" data-aos="fade-in" data-aos-delay="300">
                        <img src="{{ asset('assets/images/clients-01.svg') }}" alt="Image" class="img-fluid">
                    </div>
                    <div class="col" data-aos="fade-in" data-aos-delay="400">
                        <img src="{{ asset('assets/images/clients-04.svg') }}" alt="Image" class="img-fluid">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ asset('assets/images/img_1.jpg') }}" class="media-1" data-fancybox="gallery">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ asset('assets/images/img_2.jpg') }}" class="media-1" data-fancybox="gallery">
                            <img src="{{ asset('assets/images/img_2.jpg') }}" alt="Image" class="img-fluid">
                            <div class="media-1-content">
                                <h2>Wrist Watches</h2>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ asset('assets/images/img_3.jpg') }}" class="media-1" data-fancybox="gallery">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ asset('assets/images/img_4.jpg') }}" class="media-1" data-fancybox="gallery">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ asset('assets/images/img_5.jpg') }}" class="media-1" data-fancybox="gallery">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ asset('assets/images/img_6.jpg') }}" class="media-1" data-fancybox="gallery">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ asset('assets/images/img_7.jpg') }}" class="media-1" data-fancybox="gallery">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ asset('assets/images/img_8.jpg') }}" class="media-1" data-fancybox="gallery">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ asset('assets/images/img_9.jpg') }}" class="media-1" data-fancybox="gallery">
                            <img src="{{ asset('assets/images/img_9.jpg') }}" alt="Image" class="img-fluid">
                            <div class="media-1-content">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ asset('assets/images/img_10.jpg') }}" class="media-1" data-fancybox="gallery">
                            <img src="{{ asset('assets/images/img_10.jpg') }}" alt="Image" class="img-fluid">
                            <div class="media-1-content">
                                <h2>Battle Creek</h2>
                                <span class="category">Web Application</span>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ asset('assets/images/img_11.jpg') }}" class="media-1" data-fancybox="gallery">
                            <img src="{{ asset('assets/images/img_11.jpg') }}" alt="Image" class="img-fluid">
                            <div class="media-1-content">
                                <h2>Nouri</h2>
                                <span class="category">Branding</span>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="{{ asset('assets/images/img_12.jpg') }}" class="media-1" data-fancybox="gallery">
                            <img src="{{ asset('assets/images/img_12.jpg') }}" alt="Image" class="img-fluid">
                            <div class="media-1-content">
                                <h2>Fiber Cloth</h2>
                                <span class="category">Website</span>
                            </div>
                    ...
                    <div class="col-12 w-100 ft-feature-1-content">
                        <div class="row align-items-center">
                            <div class="col-lg-5" data-jarallax-element="50">
                                ...
                                <img src="{{ asset('assets/images/img_13.jpg') }}" alt="Image" class="img-fluid mb-4 mb-lg-0">
            ...
            <div class="slide-one-item home-slider owl-carousel">
                ...
                <div>
                    <div class="testimonial">
                        ...
                        <figure class="mb-4 d-block align-items-center justify-content-center">
                            <div><img src="{{ asset('assets/images/person_5.jpg') }}" alt="Image" class="w-50 img-fluid mb-3"></div>
                            <p>Bruce Rogers</p>
                        </figure>
            ...
            <div class="container">
                <div class="row mb-5">
                    ...
                    <div class="col-md-5 ml-auto mb-5 order-md-2" data-jarallax-element="50">
                        <img src="{{ asset('assets/images/img_13.jpg') }}" alt="Image" class="img-fluid rounded">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
                        <div class="person text-center bg-white p-4">
                            <img src="{{ asset('assets/images/person_2.jpg') }}" alt="Image" class="img-fluid rounded-circle mb-3">
                            <h3>John Rooster</h3>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
                        <div class="person text-center bg-white p-4">
                            <img src="{{ asset('assets/images/person_3.jpg') }}" alt="Image" class="img-fluid rounded-circle mb-3">
                            <h3>Tom Sharp</h3>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
                        <div class="person text-center bg-white p-4">
                            <img src="{{ asset('assets/images/person_4.jpg') }}" alt="Image" class="img-fluid rounded-circle mb-3">
...
<!-- Mirrored from themewagon.github.io/strategy/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 May 2025 01:55:59 GMT -->
